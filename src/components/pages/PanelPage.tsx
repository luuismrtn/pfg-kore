...
function PanelPage() {
  return (
    <div className="relative flex flex-col h-full">
      ...
      <button
        className="absolute bottom-8 right-8 size-14 rounded-full bg-primary text-contrast shadow-(--shadow-primary-20-strong) flex items-center justify-center hover:scale-110 transition-transform z-30"
